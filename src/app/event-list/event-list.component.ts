...
export class EventListComponent implements OnInit{
  ...
  private apiUrl = 'https://wag10.bowlab.net/get_events.php';
  private addEventUrl = 'https://wag10.bowlab.net/add_event.php';
  private updateEventUrl = 'https://wag10.bowlab.net/update_event.php';
