...
export class BookingListComponent implements OnInit{
  ...
  private bookingsApiUrl = 'https://wag10.bowlab.net/get_pending_payment_users.php';
  private usersApiUrl = 'https://wag10.bowlab.net/get_pending_users.php';
  private confirmedBookingsApiUrl = 'https://wag10.bowlab.net/get_confirm.php';
  private confirmBookingApiUrl = 'https://wag10.bowlab.net/update_payment_status.php';
