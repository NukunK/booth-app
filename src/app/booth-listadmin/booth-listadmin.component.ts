...
@Component({
  selector: 'app-booth-listadmin',
  standalone: true,
  imports: [HttpClientModule,CommonModule,FormsModule],
  templateUrl: './booth-listadmin.component.html',
  styleUrl: './booth-listadmin.component.scss'
})
export class BoothListadminComponent {
  booths: any[] = [];
  zoneId: string = '';
  zoneName: string = ''; 
  ...
  private apiUrl = 'https://wag10.bowlab.net/s_booth_by_zone_id.php';
  private addBoothUrl = 'https://wag10.bowlab.net/insert_booth.php';
  private deleteBoothUrl = 'https://wag10.bowlab.net/delete_booth.php';
  private updateBoothUrl = 'https://wag10.bowlab.net/update_booth.php';
